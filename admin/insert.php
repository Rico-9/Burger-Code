<?php
    ...
    if(!empty($_POST))
    {
        ...
        {
            $descriptionError = 'Merci de remplir ce champs';
            $isSuccess = false;    
        }if(empty($price))
        {
            $priceError = 'Merci de remplir ce champs';
            $isSuccess = false;    
        }if(empty($category))
        {
            $categoryError = 'Merci de remplir ce champs';
            $isSuccess = false;    
        }if(empty($image))
        {
            $imageError = 'Merci de remplir ce champs';
            $isSuccess = false;    
        }
        else
        {
